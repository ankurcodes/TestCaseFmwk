...
/**
 * Class that builds a random tree. Each node stores a random name from a
 * Sequence of names.
 *
...
public class RandomTreeBuilder {
	...
	/**
	 * Recursively build a random tree. The algorithm builds a subtree with n
	 * nodes with root node p as follows: - If n=1 then do nothing - Otherwise -
	 ...
	 * children subtrees. - randomly permute the order of sizes. - recursively
	 * build each subtree
	 */
	// b6.3
